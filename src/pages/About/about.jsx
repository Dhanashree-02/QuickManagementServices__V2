...
import { FaAward, FaChartLine, FaHandshake, FaLightbulb, FaUsers } from "react-icons/fa";
...
const About = () => {
  return (
    <div className={styles.about}>
      ...
      {/* New Section - Analyze, Strategy, Result */}
  ...
  <div className="container">
    ...
    <div className={styles.methodGrid}>
      {[
        {
          title: "Analyze",
          desc: "We utilize creative and customized methods tailored to client environments to maximize results.",
          icon: <FaChartLine />,
        },
        {
          title: "Strategy",
          desc: "We deliver business results via hands-on execution and leading teams through complex change.",
          icon: <FaLightbulb />,
        },
        {
          title: "Result",
          desc: "We provide valuable guidance and support in development, helping you run a successful business.",
          icon: <FaAward />,
        },
      ].map((item, i) => (
        <motion.div
